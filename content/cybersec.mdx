...
import { CustomLink } from "../src/declarations/components/CustomLink";
...
<>
    <p className="mt-6 text-sm">
        <CustomLink href="/#projects">See my</CustomLink>  or <CustomLink href="mailto:matthewhgarry@gmail.com">contact me</CustomLink>.
    </p>
