...
*(Note: Don't forget to actually upload an image here or remove this line!)*
...
**Check out my [Projects](/src/app/page.tsx#projects) to see my secure coding practices in action.**
